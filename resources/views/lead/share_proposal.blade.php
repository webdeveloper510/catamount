...
$proposalSettingArg = json_decode($settings['proposal']);
        ...
        <div class="">
            <dl class="row">
                ...
                <dl class="row">
                    ...
                    <dt class="col-md-2"><span class="h6 mb-0">{{__('Date of service')}}</span></dt>
                    <dd class="col-md-4">
                        <input type="text" name="pdf[client][dateOfService]" class="form-control dateChangeFormat" id="dateOfService2" value="{{ $lead->start_date }}">
                    </dd>
                    <dt class="col-md-2"><span class="h6 mb-0">{{__('Services')}}</span></dt>
                    <dd class="col-md-10">
                    ...
                    <dd class="col-md-10">
                        <input type="text" name="pdf[from][name]" class="form-control" id="client" value="{{ @$proposalDataArg->from->name ?? $users->name }}">
                    </dd>
                    <dt class="col-md-2"><span class="h6 mb-0">{{__('Title')}}</span></dt>
                    <dd class="col-md-4">
                        <input type="text" name="pdf[from][designation]" class="form-control" id="client" value="{{ @$proposalDataArg->from->designation ?? $users->title }}">
                    </dd>
                    <dt class="col-md-2"><span class="h6 mb-0">{{__('Date')}}</span></dt>
                    <dd class="col-md-4">
                        <input type="text" name="pdf[from][date]" class="form-control dateChangeFormat" id="client3" value="{{ @$proposalDataArg->from->date ?? date('Y-m-d') }}">
                    </dd>
                    <hr class="mt-4 mb-4">
                    <dt class="col-md-2"><span class="h6 mb-0">{{__('Name')}}</span></dt>
                    <dd class="col-md-10">
                    ...
                    <dd class="col-md-4">
                        ...
                        <input type="text" name="pdf[to][date]" class="form-control dateChangeFormat" id="client2" value="">
                    </dd>
