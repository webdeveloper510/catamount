                                                        ...
                                                        <div class="card-header">
                                                            <div class="row">
                                                                <div class="col-lg-8 col-md-8 col-sm-8">
                                                                    <h5>{{ __('Training Type Settings') }}</h5>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="card-body">
                                                            <div class="row mt-3">
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                    {{ Form::label('event_type', __('Training Type'), ['class' => 'form-label']) }}
                                                                    {{ Form::text('event_type',null,['class' => 'form-control ', 'placeholder' => __('Enter Training Type'), 'required' => 'required']) }}
                                                                </div>
                                                                <div class="text-end">
                                                                    {{ Form::submit(__('Save'), ['class' => 'btn-submit btn btn-primary']) }}
                                                                </div>
                                                ...
                                                <div id="venue-settings" class="card">
                                                    <div class="col-md-12">
                                                        <div class="card-header">
                                                            <div class="row">
                                                                <div class="col-lg-8 col-md-8 col-sm-8">
                                                                    <h5>{{ __('Training Location Settings') }}</h5>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="card-body">
                                                            <div class="row mt-3">
                                                                ...
                                                                @csrf
                                                                <div class="form-group col-md-12">
                                                                    {{ Form::label('venue', __('Training Location'), ['class' => 'form-label']) }}
                                                                    {{ Form::text('venue',null,['class' => 'form-control ', 'placeholder' => __('Enter Training Location'), 'required' => 'required']) }}
                                                                </div>
                                                                <div class="text-end">
                                                                    {{ Form::submit(__('Save'), ['class' => 'btn-submit btn btn-primary']) }}
                                                                </div>
