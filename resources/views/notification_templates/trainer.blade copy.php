...
<body style="font-family: Arial, sans-serif; color: #333; line-height: 1.6; background-color: #f4f4f4; padding: 20px; margin: 0;">
    <div style="background-color: #ffffff; padding: 20px; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); max-width: 600px; margin: 0 auto;">
        ...
        <p style="font-size: 16px;">Dear <strong>{{$data['userName']}},</strong></p>

        <p style="font-size: 16px;">I hope this email finds you well.</p>

        <p style="font-size: 16px;">We are pleased to inform you that a trainer has been assigned to assist you with your <strong>{{$data['trainingType']}}</strong>. <strong>{{$data['trainerName']}}</strong>, our experienced trainer, will be guiding you through the training sessions to ensure you gain the knowledge and skills you need.</p>
