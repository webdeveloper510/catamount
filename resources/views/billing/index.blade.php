                                    ...
                                    <table id="datatable" class="table datatable align-items-center">
                                        <thead class="thead-light">
                                            <tr>
                                                ...
                                                <th scope="col" class="sort" data-sort="completion">
                                                    {{ __('Invoice Amount') }}<span class="opticy"> dddd</span>
                                                </th>
                                                <th scope="col" class="sort" data-sort="completion">
                                                    {{ __('Paid Amount') }} <span class="opticy"> dddd</span>
                                                </th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="" data-size="md" data-title="{{ __('Invoice Details') }}" class="action-item text-primary">
                                                        <a href="{{route('meeting.detailview',urlencode(encrypt($event->id)))}}" data-size="md" title="{{ __('Detailed view ') }}" style="color: #1551c9 !important;">
                                                ...
                                                <td>
                                                    ...
                                                    <span class="budget">{{ Carbon\Carbon::parse($event->start_date)->format('M d')}}
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    @can('Create Payment')
                                                    <div class="action-btn bg-primary ms-2">
                                                        <a href="#" data-size="md" data-url="{{ route('billing.create',['billing',$event->id]) }}" data-bs-toggle="tooltip" title="{{__('Create')}}" data-ajax-popup="true" data-title="{{__('Invoice Details')}}" class="mx-3 btn btn-sm d-inline-flex align-items-center text-white ">
                                                    ...
                                                    <div class="action-btn bg-primary ms-2">
                                                        <a href="#" data-size="md" data-url="{{ route('billing.paylink',$event->id) }}" data-bs-toggle="tooltip" title="{{__('Share Payment Link')}}" data-ajax-popup="true" data-title="{{__('Payment Link')}}" class="mx-3 btn btn-sm d-inline-flex align-items-center text-white ">
                                                    ...
                                                    <div class="action-btn bg-info ms-2">
                                                        <a href="#" data-size="md" data-url="{{ route('billing.paymentinfo',urlencode(encrypt($event->id))) }}" data-bs-toggle="tooltip" title="{{__('Payment')}}" data-ajax-popup="true" data-title="{{__('Payment Information')}}" class="mx-3 btn btn-sm d-inline-flex align-items-center text-white ">
