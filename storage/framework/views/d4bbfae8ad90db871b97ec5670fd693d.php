...
<?php if($status > 1): ?>
<a href="#" data-size="md" data-url="<?php echo e(route('lead.shareproposal',urlencode(encrypt($decryptedId)))); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" data-title="<?php echo e(__('Proposal')); ?>" title="<?php echo e(__('Share Proposal')); ?>" class="btn btn-sm btn-primary btn-icon m-1">
                                    ...
                                    <table class="table datatable" id="datatable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?php echo e(route('lead.viewproposal',urlencode(encrypt($info->lead_id)))); ?>" style=" color: teal;">View
                                                        Document</a></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\0Work\xampp\htdocs\laravel\ash\catamount\resources\views/lead/proposal_information.blade.php ENDPATH**/ ?>