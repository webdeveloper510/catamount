                    ...
                    <table class="table datatable" id="pc-dt-export">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="sort" data-sort="name"><?php echo e(__('Training')); ?> <span class="opticy">
                                        dddd</span></th>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\0Work\xampp\htdocs\laravel\ash\catamount\resources\views/report/leadsanalytic.blade.php ENDPATH**/ ?>