                        ...
                        <div class="table">
                            <table style="width: 100%; border-collapse: collapse; margin: 20px 0; font-family: Arial, sans-serif; background-color: #f9f9f9;">
                                ...
                                <tr style="border-bottom: 1px solid #ddd;">
                                    ...
                                    <td style="padding: 8px;"><input type="text" name="to[name]" id="name" value="<?php echo e(@$proposal_info->to->name); ?>"></td>
                                </tr>
                                <tr style="border-bottom: 1px solid #ddd;">
                                    <td style="padding: 8px;">Title</td>
                                    ...
                                    <td style="padding: 8px;"><input type="text" name="to[designation]" id="designation" value="<?php echo e(@$proposal_info->to->designation); ?>"></td>
                                </tr>
                                <tr>
                                    <td style="padding: 8px;">Date</td>
