                    ...
                    <div class="row">
                        ...
                        <div class="table">
                            <table style="width: 100%; border-collapse: collapse; margin: 20px 0; font-family: Arial, sans-serif; background-color: #f9f9f9;">
                                ...
                                <tr style="border-bottom: 1px solid #ddd;">
                                    <td style="padding: 8px;">Name</td>
                                    <!-- <td style="padding: 8px;"><input type="text" name="to[name]" id="name" value="<?php echo e(isset($proposal_info->to->name) ? $proposal_info->to->name : ''); ?>"></td> -->
                                    <td style="padding: 8px;"><input type="text" name="to[name]" id="name" value="<?php echo e(@$secondary_contact->name); ?>"></td>
                                </tr>
                                <tr style="border-bottom: 1px solid #ddd;">
                                    <td style="padding: 8px;">Title</td>
                                    <!-- <td style="padding: 8px;"><input type="text" name="to[designation]" id="designation" value="<?php echo e(isset($proposal_info->to->name) ? $proposal_info->to->designation : ''); ?>"></td> -->
                                    <td style="padding: 8px;"><input type="text" name="to[designation]" id="designation" value="<?php echo e(@$secondary_contact->relationship); ?>"></td>
                                </tr>
                                <tr>
                                    <td style="padding: 8px;">Date</td>
                                    <td style="padding: 8px;"><input type="date" name="to[date]" id="date" value="<?php echo e(date('Y-m-d')); ?>"></td>
                                </tr>
                            </table>
                        </div>
                    </div>
...
</script><?php /**PATH D:\0Work\xampp\htdocs\laravel\ash\catamount\resources\views/lead/proposal.blade.php ENDPATH**/ ?>