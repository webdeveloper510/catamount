                                ...
                                <div class="table-responsive overflow_hidden">
                                    <table id="datatable" class="table datatable align-items-center">
                                        <thead class="thead-light">
                                            <tr>
                                                ...
                                                <th scope="col" class="sort" data-sort="completion">
                                                    <?php echo e(__('Event Date')); ?> <span class="opticy"> dddd</span>
                                                </th>
                                                <th scope="col" class="sort" data-sort="completion">
                                                    <?php echo e(__('Payment Status')); ?> <span class="opticy"> dddd</span>
                                                </th>
                                                <th scope="col" class="sort" data-sort="completion">
                                                    <?php echo e(__('Invoice Amount')); ?><span class="opticy"> dddd</span>
                                                </th>
                                                <th scope="col" class="sort" data-sort="completion">
                                                    <?php echo e(__('Paid Amount')); ?> <span class="opticy"> dddd</span>
                                                </th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="" data-size="md" data-title="<?php echo e(__('Invoice Details')); ?>" class="action-item text-primary">
                                                        <a href="<?php echo e(route('meeting.detailview',urlencode(encrypt($event->id)))); ?>" data-size="md" title="<?php echo e(__('Detailed view ')); ?>" style="color: #1551c9 !important;">
                                                ...
                                                <td>
                                                    ...
                                                    <span class="budget"><?php echo e(Carbon\Carbon::parse($event->start_date)->format('M d')); ?>
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <div class="action-btn bg-primary ms-2">
                                                        <a href="#" data-size="md" data-url="<?php echo e(route('billing.create',['billing',$event->id])); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Create')); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Invoice Details')); ?>" class="mx-3 btn btn-sm d-inline-flex align-items-center text-white ">
                                                    ...
                                                    <div class="action-btn bg-primary ms-2">
                                                        <a href="#" data-size="md" data-url="<?php echo e(route('billing.paylink',$event->id)); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Share Payment Link')); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Payment Link')); ?>" class="mx-3 btn btn-sm d-inline-flex align-items-center text-white ">
                                                    ...
                                                    <div class="action-btn bg-info ms-2">
                                                        <a href="#" data-size="md" data-url="<?php echo e(route('billing.paymentinfo',urlencode(encrypt($event->id)))); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Payment')); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Payment Information')); ?>" class="mx-3 btn btn-sm d-inline-flex align-items-center text-white ">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\0Work\xampp\htdocs\laravel\ash\catamount\resources\views/billing/index.blade.php ENDPATH**/ ?>