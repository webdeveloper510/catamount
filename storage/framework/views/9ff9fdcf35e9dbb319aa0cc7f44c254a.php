                        ...
                        <div id="useradd-1" class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-6 need_full">
                                        <div class="form-group intl-tel-input">
                                            ...
                                            <div class="intl-tel-input">
                                                <input type="tel" id="phone-input" name="primary_contact" class="phone-input form-control" placeholder="Enter phone" maxlength="16" value="" required>
                                    ...
                                    <div class="col-6 need_full">
                                        <div class="form-group">
                                            <label for="venue" class="form-label"><?php echo e(__('Training Location')); ?></label>
                                            <!-- <span class="text-sm">
                                                <i class="fa fa-asterisk text-danger" aria-hidden="true"></i>
                                            </span> -->
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\0Work\xampp\htdocs\laravel\ash\catamount\resources\views/lead/edit.blade.php ENDPATH**/ ?>